        ...
        if (isset($fileList))
            if (is_array($fileList))
                foreach ($fileList as $dir) {
                    echo "<a target='_blank' href='?f=$d" . $slash . $dir['dir'] . "'><font color=" . $dir['color'] . ">" . $dir['dir'] . "</font></a>" .
                        "|<a href='?dl=$d" . $slash . '&file=' . $dir["dir"] . "' target='_blank'>Download</a>|" .
                        "|<a href='?ef=$d" . $slash . '&file=' . $dir["dir"] . "' target='_blank'>Edit</a>|" .
                        "|<a href='?df=$d" . $slash . '&file=' . $dir["dir"] . "' target='_blank'>Delete</a>| \n";
                }
    } else
        echo "opendir() failed";
    closedir($handle);
...
?>
    ...
    <b>Go to any directory:</b>
    <form action="" method="GET"><input type="text" name="d" value="<?php echo $rootDir; ?>" /><input type="submit" value="Go" /></form>
